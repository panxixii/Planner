...
const UI_COLOR_PALETTE = [
  { name: '暗夜黑', value: '#16131F' },
  { name: '山雾粉', value: '#F0D9E4' },
  { name: '豆沙粉', value: '#C1A0AC' },
  { name: '深灰紫', value: '#4A3F4B' },
  { name: '月岩灰', value: '#806C79' },
  { name: '柠檬黄', value: '#F8E473' },
  { name: '阳光橙', value: '#FFB40F' },
  { name: '泡泡粉', value: '#E41E71' },
  { name: '蜜瓜红', value: '#FF6161' },
  { name: '牛油果绿', value: '#A7B408' },
  { name: '海港蓝', value: '#96C1DD' },
  { name: 'Vintage Violet', value: '#625060' },
  { name: 'Purple Grey', value: '#826A84' },
  { name: "Knight's Tale", value: '#A78FAB' },
  { name: 'Seedless Grape', value: '#D1C3D4' },
  { name: 'Late Night Out', value: '#3A2B32' },
  { name: 'Lush Mauve', value: '#A191B6' },
  { name: 'Poetry Mauve', value: '#846992' },
  { name: 'Kikyō Purple', value: '#604268' },
  { name: 'Kokimurasaki Purple', value: '#391F3C' },
  { name: 'Estate Violet', value: '#C0BED1' },
  { name: 'Ruby Star', value: '#B71022' },
  { name: 'Radishical', value: '#E2466D' },
  { name: 'Double Bubble', value: '#E894B3' },
  { name: 'Coated', value: '#2E2F31' },
  { name: 'Bean Pot', value: '#8C6A51' },
  { name: 'Evaporation', value: '#CCCFD0' },
  { name: 'Lunar Green', value: '#515546' },
  { name: 'Beijing Moon', value: '#A8A0A3' },
  { name: 'Settlement', value: '#7D796E' },
  { name: 'Maire', value: '#272B1C' },
  { name: 'Midnight Edition', value: '#17171F' },
  { name: 'To Hell and Black', value: '#251F29' },
  { name: 'Pine Grove', value: '#253F38' },
  { name: 'Plantation', value: '#41594C' },
  { name: 'Verdigris Roundhead', value: '#507F67' },
  { name: 'Porpoise', value: '#D7D7D6' },
  { name: 'Grecian Gold', value: '#9D7E54' },
  { name: 'Wild Chocolate', value: '#685235' },
  { name: 'Weathervane', value: '#2B2419' },
  { name: 'Caleskin', value: '#BE9E89' },
  { name: 'Picnic Day Sky', value: '#04BCD1' },
  { name: 'Cyanophobia', value: '#067587' },
  { name: 'Stegadon Scale Green', value: '#0A455A' },
  { name: 'Am I Blue?', value: '#3C6C7B' },
  { name: 'Bay Mist', value: '#74A5AC' },
  { name: 'Black Chestnut Oak', value: '#292625' },
  { name: 'Dark Elf', value: '#3B3C3F' },
  { name: 'Blue Insignia', value: '#53636D' },
  { name: 'Silver Storm', value: '#5F6D7A' },
  { name: 'Cemetery Ash', value: '#8B98A8' },
  { name: 'Swanky Grey', value: '#8F8E93' },
  { name: 'Dark Stormcloud', value: '#829093' },
  { name: 'Blue Blood', value: '#6B7E81' },
  { name: 'Metropolis Mood', value: '#707F81' },
  { name: 'Sumatra Chicken', value: '#6D7C7D' },
] as const;
